include $(MOD)/sdk.mak
WICED_SDK		:= $(MOD)/WICED-SDK-$(WICED_VERSION)
...
CDEFINES  += WICED_DISABLE_BOOTLOADER WICED_DISABLE_STDIO WICED_DISABLE_WATCHDOG NETWORK_LwIP=1 WICED_SDK_VERSION=\"$(WICED_VERSION)\"
